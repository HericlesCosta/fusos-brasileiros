...
function Manaus() {
  const [time, setTime] = useState(
    moment.tz("America/Manaus").format("DD MM YYYY HH:mm:ss")
  );

  useEffect(() => {
    const interval = setInterval(() => {
      setTime(moment().tz("America/Manaus").format("DD MM YYYY HH:mm:ss"));
    }, 1000);
  ...
  return (
    <div id="container">
      ...
      <h1 id="titulo-fuso">Fuso do Amazonas GMT-4</h1>
